...
accuracies = np.array(list(csv.reader(open("h2_accuracies_30-41_0006-0051.csv"), delimiter=","))).astype(
    "float")
f1s = np.array(list(csv.reader(open("h2_f1s_30-41_0006-0051.csv"), delimiter=","))).astype("float")
Y, X = np.meshgrid(Y, X)
