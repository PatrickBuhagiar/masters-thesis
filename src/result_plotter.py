...
accuracies = np.array(list(csv.reader(open("h3_accuracies_40-61_00001-00008.csv"), delimiter=","))).astype(
    "float")
f1s = np.array(list(csv.reader(open("h3_f1s_40-61_00001-00008.csv"), delimiter=","))).astype("float")
Y, X = np.meshgrid(Y, X)
...
plt.title("Hypothesis 2 - 3D plot for Number of Nodes VS Learning Rate VS F1 Score")
